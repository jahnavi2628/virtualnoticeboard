...
const SignUpPage: React.FC<SignUpPageProps> = ({ onSignUp }) => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    // For this mock, we'll create a user and log them in immediately.
    const newUser: User = {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-dark-bg">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-dark-surface rounded-xl shadow-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-brand-primary dark:text-brand-accent">Create Account</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-300">Join the RGUKT Hub</p>
        </div>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-dark-text focus:outline-none focus:ring-brand-secondary focus:border-brand-secondary focus:z-10 sm:text-sm bg-transparent dark:bg-gray-700"
